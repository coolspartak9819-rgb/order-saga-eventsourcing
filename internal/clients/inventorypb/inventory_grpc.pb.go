...
type InventoryServiceClient interface {
	ReserveInventory(ctx context.Context, in *ReserveInventoryRequest, opts ...grpc.CallOption) (*InventoryResponse, error)
	CancelReservation(ctx context.Context, in *CancelReservationRequest, opts ...grpc.CallOption) (*InventoryResponse, error)
}
...
func (c *inventoryServiceClient) ReserveInventory(ctx context.Context, in *ReserveInventoryRequest, opts ...grpc.CallOption) (*InventoryResponse, error) {
...
func (c *inventoryServiceClient) CancelReservation(ctx context.Context, in *CancelReservationRequest, opts ...grpc.CallOption) (*InventoryResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(InventoryResponse)
...
type InventoryServiceServer interface {
	ReserveInventory(context.Context, *ReserveInventoryRequest) (*InventoryResponse, error)
	CancelReservation(context.Context, *CancelReservationRequest) (*InventoryResponse, error)
...
func (UnimplementedInventoryServiceServer) ReserveInventory(context.Context, *ReserveInventoryRequest) (*InventoryResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ReserveInventory not implemented")
}
func (UnimplementedInventoryServiceServer) CancelReservation(context.Context, *CancelReservationRequest) (*InventoryResponse, error) {
